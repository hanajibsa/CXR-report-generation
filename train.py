...
def main(args, config):
    ...
    model = blip_pretrain(image_size=config['image_size'], vit=config['vit'], vit_grad_ckpt=config['vit_grad_ckpt'], 
                            vit_ckpt_layer=config['vit_ckpt_layer'], queue_size=config['queue_size'], BERT_model=args.pretrain_BERT)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrain_BERT', default='', help='pretrained BERT model to use text encoder, decoder')
